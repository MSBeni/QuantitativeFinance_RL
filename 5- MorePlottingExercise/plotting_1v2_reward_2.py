...
for i in range(len(df_reward_new['reward_DDPG'])):
    if i != 0:
        df_reward_new['reward_DDPG'][i] = df_reward_new['reward_DDPG'][i] + \
                                                  df_reward_new['reward_DDPG'][i - 1]

        df_reward_new['reward_MADDPG'][i] = df_reward_new['reward_MADDPG'][i] + \
                                                    df_reward_new['reward_MADDPG'][i - 1]

        df_reward_new['reward_DQN'][i] = df_reward_new['reward_DQN'][i] + \
                                                 df_reward_new['reward_DQN'][i - 1]

        df_reward_new['reward_MAMMKTD'][i] = df_reward_new['reward_MAMMKTD'][i] + \
                                                     df_reward_new['reward_MAMMKTD'][i - 1]
...
error = (df_reward_new['reward_DDPG'].std())/100000
...
error = (df_reward_new['reward_MADDPG'].std())/100000
...
error = (df_reward_new['reward_DQN'].std())/100000
...
error = (df_reward_new['reward_MAMMKTD'].std())/100000
